 ...
 **/
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==itemRegistrarPersonas) {
            miCoordinador.mostrarVentanaRegistroPersona();
        }
        if (e.getSource()==itemRegistrarMascotas) {
            miCoordinador.mostrarVentanaRegistroMascota();
        }
        if (e.getSource()==itemRegistroProductos) {
            RegistrarProductoGui RegistrarProductos=new RegistrarProductoGui(this, true);
